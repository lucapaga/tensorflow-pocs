...
# --    [taken from prova01-train.py]
# ------------------------------------------------------------------------------
input_layer_neurons=784                 # number of input neurons
first_h_layer_neurons=400               # number of neurons into 1st hidden layer
second_h_layer_neurons=400              # number of neurons into 1st hidden layer
